...
<body>
    ...
    <h4 class="fw-normal">อัพเดทข้อมูลผู้ใช้งาน <small class="text-muted">Manage User</small></h4>
        <hr>
        <?php
            $userid = $_GET['id']; // รับ ID จาก query string
        ...
        <form action="" method="post">
            ...
            <a href="index.php?p=dashboard_user/manageuser" class="btn btn-primary">กลับสู่หน้า แดชบอร์ด</a>
        </form>
    </div>
